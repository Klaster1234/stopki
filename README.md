...
Jedna stopka dla wszystkich: czarno-biała, po angielsku (nazwa fundacji po polsku, pod nią „Cluster of Social Innovations”), znak Klastra, dane osoby, adres biura w Gliwicach, linki do socjali fundacji. Trzy style: A czarny kafelek ze znakiem i tekst obok, B kompaktowa wizytówka z kreską, C układ pionowy ze znakiem nad nazwiskiem.
...
1. `python generuj.py --styl A --imie "Anna Nowak" --stanowisko "Project Coordinator" --telefon "+48 732 259 513" --email anna.nowak@klaster.org.pl`
   `--styl` A, B albo C; `--dzial "Silesian Migrant Career Centre"` dopisze szarą linię pod nazwą fundacji.
